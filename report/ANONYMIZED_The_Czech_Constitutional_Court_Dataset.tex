...
\textbf{Current version}: January 29, 2024}}
\author{true}
...
This article presents a novel Czech Constitutional Court dataset. The
dataset is foundational in that it encompasses plethora of data that
other researches can base their research efforts on, it has the capacity
address research questions and it adheres to the tidy data principles.
The dataset encompasses all decisions of the CCC starting from its
founding in 1993 until the end of 2023, including plenty of metadata and
a complete text corpus, as well additional background information on
judges or clerks.
...
Such a finding offers a potential for more in-depth inquiry into the
background, hiring and role of clerks.
