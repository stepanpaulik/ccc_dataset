...
data_compositions = read_rds("../data/ccc_dataset/rds/ccc_compositions.rds")
data_separate_opinions = read_rds("../data/ccc_dataset/rds/ccc_separate_opinions.rds")
...
# check = check_compositions |>
#   filter(formation == "Plenum" & n < 3)
# 
# check2 = check_compositions |>
#   filter(formation == "Panel" & n > 3)
